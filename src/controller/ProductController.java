...
public class ProductController {
    ...
    public void addNewProduct() throws ExceptionHandle {
        try {
            ...
            productService.addNewProduct(Product.builder()
                    ...
                    .expriedDate(Date.valueOf(LocalDate.of(expiredYear, expiredMonth, expiredDay)))
    ...
    public void updateProduct() throws ExceptionHandle {
